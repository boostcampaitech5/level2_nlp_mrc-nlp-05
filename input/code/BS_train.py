...
def run_mrc(
    ...
    def prepare_train_features(examples):
        ...
        for i, offsets in enumerate(offset_mapping):
            ...
            sentence_start = examples['answer_sentence'][sample_mapping[i]][0]
            sentence_end = examples['answer_sentence'][sample_mapping[i]][1]
            ...
            tokenized_examples["sentence_start"].append(start)
            tokenized_examples["sentence_end"].append(end)
    ...
    trainer = QuestionAnsweringTrainer(
        ...
        eval_examples= datasets["validation"] if training_args.do_eval else None, # datasets["validation"]
        tokenizer=tokenizer,
